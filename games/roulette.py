...
class Roulette():
    ...
    def draw(self):
        ...
        for x in range(6):
            for y in range(1, 4):
                ...
                pyxel.blt(x * 225,  (y - 1) * 170, 0, 0, 0, 225, 170)
    ...
    def add_ball_on_roulette(self):
            coordRouletteBall = {0: [242, 55], 1: [127, 351], 2: [389, 139], 3: [184, 64], 4: [352, 94], 5: [232, 400], 6: [413, 251], 7: [99, 135], 8: [316, 385], 9: [71, 248], 10: [257, 399], 11: [362, 351],
            12: [134, 93], 13: [395, 306], 14: [90, 307], 15: [301, 65], 16: [172, 385], 17: [411, 192], 18: [76, 193], 19: [327, 77], 20: [107, 331], 21: [372, 111], 22: [73, 220], 23: [288, 393], 24: [200, 395],
            25: [403, 163], 26: [212, 57], 27: [406, 279], 28: [114, 112], 29: [82, 162], 30: [341, 368], 31: [79, 279], 32: [272, 57], 33: [148, 371], 34: [415, 221], 35: [159, 74], 36: [383, 329]}
